...
if [[ ${BLE_VERSION-} ]]; then
  ...
  bleopt edit_bell=
  ble-bind -m emacs -f up 'history-search-backward hide-status:point=end:immediate-accept'
  ble-bind -m emacs -f down 'history-search-forward hide-status:point=end:immediate-accept'
